...
#include "../MetricEvol/clonedialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CloneDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 34, 0) // ""
    ...
    "CloneDialog\0on_buttonBox_accepted\0"
};
...
void CloneDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CloneDialog *_t = static_cast<CloneDialog *>(_o);
        switch (_id) {
...
const QMetaObject CloneDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CloneDialog.data,
      qt_meta_data_CloneDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CloneDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CloneDialog.stringdata))
        return static_cast<void*>(const_cast< CloneDialog*>(this));
